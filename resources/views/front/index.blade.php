...
<body>
  ...
  <header class="relative flex flex-col w-full h-[712px]">
    ...
    <div class="relative flex flex-col mt-[244px] gap-5 items-center">
      <p class="flex items-center gap-[6px] rounded-full py-[6px] px-3 bg-white bg-white border border-tedja-border">
        ...
        <span class="font-semibold text-sm">Top Well-Designed House by Someone</span>
      </p>
    ...
    <form action="search-result.html"
      ...
      <div class="flex flex-col w-full max-w-[241px] gap-2 h-[84px]">
        ...
        <label class="relative">
          ...
          <img src="{{ asset('assets/images/icons/arrow-down.svg') }}" class="absolute size-5 transform -translate-y-1/2 top-1/2 right-5"
            alt="icon">
        </label>
      </div>
  ...
  <section id="Testimonials" class="flex flex-col w-full max-w-[1280px] px-[135px] gap-[31px] mx-auto my-[70px]">
    ...
    <div id="Slider-Container" class="relative flex gap-[30px] w-[1010px] h-[650px] shrink-0 overflow-hidden">
      <div class="gradient absolute z-10 top-0 w-full h-[186px] bg-[linear-gradient(180deg,rgba(250,250,250,0)_0%,#FAFAFA_100%)] rotate-180">
      </div>
      <div class="gradient absolute z-10 bottom-0 w-full h-[100px] bg-[linear-gradient(180deg,rgba(250,250,250,0)_0%,#FAFAFA_100%)]">
      </div>
        ...
        <div class="h-max">
          <div class="content flex flex-col gap-[30px] pt-[30px]">
            <div class="testimonial-card flex flex-col w-full rounded-[30px] border border-tedja-border bg-white p-4 gap-[14px]">
              ...
              <p class="font-semibold leading-[28px]">Awalnya takut dibawa kabur duitnya lalu dolor dicoba
                kok malah amet lorem dolor si happines puas pokoknya mas</p>
            ...
            <div class="testimonial-card flex flex-col w-full rounded-[30px] border border-tedja-border bg-white p-4 gap-[14px]">
              ...
              <p class="font-semibold leading-[28px]">Beneran membantu banget tanpa basa basi KPR langsung
                beres</p>
              <div class="flex items-center gap-[14px]">
                <div class="flex size-[60px] rounded-full overflow-hidden">
